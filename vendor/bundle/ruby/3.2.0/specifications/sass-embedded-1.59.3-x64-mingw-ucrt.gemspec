# -*- encoding: utf-8 -*-
# stub: sass-embedded 1.59.3 x64-mingw-ucrt lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "documentation_uri" => "https://rubydoc.info/gems/sass-embedded/1.59.3", "funding_uri" => "https://github.com/sponsors/ntkme", "source_code_uri" => "https://github.com/ntkme/sass-embedded-host-ruby/tree/v1.59.3" } if s.respond_to? :metadata=
